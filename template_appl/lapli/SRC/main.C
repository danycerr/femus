...
//   P.init_interface(50,50, 2,filenameP[0].str().c_str());
...
//   P.setAnalyticBoundaryValues(50,3, "IVec*0.+JVec*0.+KVec*1."); // write in the interfacefunction.field
//   P.write_Boundary_value(50,"NS0",3);             // write inside x_old the boundary values
...
//     bdy = P1.getValuesOnBoundary(212, "NS0",1,3);          // take field from P1 problem
//     P.setFieldBoundaryValues(212,1, bdy);                // store field inside P problem
