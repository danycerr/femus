 ...
 enum  FIELDS{
    ...
    FSX_F =15,     // [0] -> Navier-Stokes (quadratic (2),NS_EQUATIONS)
    FSY_F =16,     // [1] -> Navier-Stokes (quadratic (2),NS_EQUATIONS)
    FSZ_F =17,     // [2] -> Navier-Stokes (quadratic (2),NS_EQUATIONS)    
