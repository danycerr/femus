...
// //   if(system_name=="NSP") order =1;
  ...
  #if defined FSI_EQUATIONS || defined NS_EQUATIONS
  VelField=GetVelocityField(PFemus,id);
#endif
...
#ifdef NS_EQUATIONS
  int NsSystem = NS_EQUATIONS%2;
#endif
#ifdef FSI_EQUATIONS
  int NsSystem = FSI_EQUATIONS%2;
#endif
